   ...
   <section class="module" data-background="${contextPath }/resources/images/watercolor-g227ca2d60_1280.png">
      <div class="aside col-sm-2 col-md-2" id="aside">
            ...
            <div class="row multi-columns-row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="count-item mb-sm-40">
                  ...
                  <h3 class="count-to font-alt countvalue" data-countto="${todayOrderCount }"></h3>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="count-item mb-sm-40">
                  ...
                  <h3 class="count-to font-alt countvalue" data-countto="${todayOrderInCount }"></h3>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="count-item mb-sm-40">
                  ...
                  <h3 class="count-to font-alt countvalue" data-countto="${todayOrderOutCount }"></h3>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="count-item mb-sm-40">
                  ...
                  <h3 class="count-to font-alt countvalue" data-countto="${todaySalesTotalPrice }"></h3>
        ...
        <script type="text/javascript">
           $(".countvalue").on("click", function(){
              value=$(this).siblings("h5").text();
              
              if(value=="주문량"){
                 location.href="${contextPath}/sales/sales";
              } else if(value=="매출 금액"){
                 location.href="${contextPath}/sales/sales";
              }
           });

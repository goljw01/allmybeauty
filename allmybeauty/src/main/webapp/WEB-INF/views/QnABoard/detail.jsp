          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <form role="form" id="frmNModify" name="frmNoticeBoard">
					...
					<textarea class="form-control" rows="15" name="bcontent" readonly="readonly" style="resize: none; font-size: x-small; background: white;border-color: black;"><c:out value="${NoticesDetail.bcontent}"/></textarea>
					</div>
              ...
              <c:when test="${divide == 'C'}">
                 <form role="form" id="frmCModify" name="frmCustomerBoard">
					...
					<textarea class="form-control" rows="15" name="bcontent" readonly="readonly" style="resize: none; font-size: x-small; background: white;border-color: black;"><c:out value="${CustomerDetail.bcontent}"/></textarea>
					</div>
